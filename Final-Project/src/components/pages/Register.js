    ...
    return (
        <div className="register">
            <form onSubmit={handleSubmit}>
                <h1>Register</h1>
                <input type="text" name="name" placeholder="Input Your Name" className="input-auth" value={input.name} onChange={handleChange}/>
                <input type="text" name="email" placeholder="E-Mail" className="input-auth" value={input.email} onChange={handleChange}/>
